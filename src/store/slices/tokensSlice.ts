  ...
  const baseTokens: Omit<Token, 'status'>[] = [
    {
      id: '1',
      symbol: 'Bert',
      name: 'Bertram the Pomerian',
      contractAddress: 'PU1...',
      image: '/images/bert.png', // Intentionally empty to trigger "First Letter" fallback UI
      currentPrice: 0.0034,
      priceChange24h: 24.5,
      marketCap: 45000000,
      volume24h: 2500000,
    ...
    {
      id: '15',
      symbol: 'Sell me this shitcoin',
      name: 'Shitcoin',
      contractAddress: '8wX...',
      image: '/images/shitcoin.png',
      currentPrice: 0.0085,
      priceChange24h: -15.6,
      marketCap: 58000000,
      volume24h: 125000000,
