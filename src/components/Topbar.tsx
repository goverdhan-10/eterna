    ...
    <>
      ...
      <div className="flex items-center gap-2 sm:gap-4">
        ...
        <div className="flex sm:hidden items-center gap-2">
          ...
          <div className="relative flex">
             <button className="bg-[#1C212B] hover:bg-[#2A2F3A] flex flex-row w-8 h-8 px-1.25 gap-2 justify-center items-center rounded-full">
                <img src="/images/bell.png" alt="Bell" className="w-5 h-4" />
             </button>
          </div>
          <div className="relative flex">
             <button className="bg-[#1C212B] hover:bg-[#2A2F3A] flex flex-row w-8 h-8 px-2.5 gap-2 justify-center items-center rounded-full">
                <img src="/images/wal2.png" alt="Wallet" className="w-4 h-4" />
             </button>
          </div>
          <div className="relative flex">
             <button className="bg-[#1C212B] hover:bg-[#2A2F3A] flex flex-row w-8 h-8 px-2.5 gap-2 justify-center items-center rounded-full">
        ...
        <div className="hidden sm:flex items-center gap-2 lg:gap-4">
          <button className="bg-[#1C212B] hover:bg-[#2A2F3A] flex flex-row w-8 h-8 px-1.25 gap-2 justify-center items-center rounded-full">
            <img src="/images/star.png" alt="Star" className="w-4.5 h-4.5" />
          </button>

          <div className="relative flex">
            <div className="w-full">
              <button className="relative bg-[#1C212B] hover:bg-[#2A2F3A] flex flex-row w-8 h-8 px-1.25 gap-2 justify-center items-center rounded-full">
                <img src="/images/bell.png" alt="Bell" className="w-4.5 h-4.5" />
              </button>
            </div>
          </div>
